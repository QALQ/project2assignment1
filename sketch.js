...
*/
//aslo referenced :https://p5js.org/zh-Hans/examples/interaction-wavemaker.html
...
function draw() {
  ...
  noStroke();
  fill(diameter0*255,diameter1/1023*255,diameter2/71*255);
  ...
  // make grid (this part from https://p5js.org/zh-Hans/examples/interaction-wavemaker.html)
  for (let x = 0; x <= width; x = x + 30) {
    for (let y = 0; y <= height; y = y + 30) {
      ...
      ellipse(myX, myY, 10); //draw ellipse
    }
  }
